...
* I improved autoload error display of "static backup".
* I improved "include" error display of "static backup".
* I simplified autoload class method of "static backup".
