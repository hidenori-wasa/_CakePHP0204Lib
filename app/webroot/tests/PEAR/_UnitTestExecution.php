...
function BreakpointDebugging_unitTest()
{
    ...
    // $breakpointDebugging_PHPUnit->displayCodeCoverageReport(array ('BreakpointDebugging-IniSetOptimizerTest.php', 'BreakpointDebugging-ProductionSwitcherTest.php'), array ('BreakpointDebugging_Optimizer.php', 'BreakpointDebugging_IniSetOptimizer.php', 'BreakpointDebugging_ProductionSwitcher.php')); exit;
    ...
    //
    // $breakpointDebugging_PHPUnit->displayCodeCoverageReport($breakpointDebugging_UnitTestFiles, 'BreakpointDebugging_PHPUnit.php', 'SIMPLE_OWN'); exit;
    // $breakpointDebugging_PHPUnit->displayCodeCoverageReport($breakpointDebugging_UnitTestFiles, 'BreakpointDebugging/PHPUnit/FrameworkTestCase.php', 'SIMPLE_OWN'); exit;
}

BreakpointDebugging_unitTest();
